  var runBefore = require ('../moduleGenerator/RunBeforeAspectRunner.js')
   ...
   var originalModule = require ('../controllers/DriverController.js')
   module.exports.getCarTypeList = function ( requestBody , context ) {
var original = originalModule.getCarTypeList;
 original =  runAround( original, originalModule, __dirname, "../annotationRuntimeModules/AutoWired_AspectItem_75053.js", "aspect", "{\"originalArguments\":[\"userSkip\",\"userLimit\",\"CarTypeRepo\",\"CarTypeResponseHelper\"],\"autoWiredModules\":{\"CarTypeRepo\":{\"moduleName\":\"CarTypeRepo\",\"moduleAddress\":\"../generated/CarTypeRepo.js\"},\"CarTypeResponseHelper\":{\"moduleName\":\"CarTypeResponseHelper\",\"moduleAddress\":\"../generated/CarTypeResponseHelper.js\"}}}");
 ...
 original =  runAround( original, originalModule, __dirname, "../annotationRuntimeModules/PaginationAnnotation_AspectItem_14046.js", "aspect", "{\"skipIndex\":0,\"limitIndex\":0,\"pData\":{\"indexes\":{\"requestBody\":2},\"ignoreIndexes\":[2]}}");
 ...
 original =  runAround( original, originalModule, __dirname, "../requestHandler/runtime/Controller_AspectItem_42312.js", "aspect", "{\"passIndexes\":[1,0],\"requestType\":\"../reqAndRes/requests/general/PaginationRequest.js\",\"responseType\":\"../reqAndRes/responses/CarTypeListItemResponseList.js\",\"requestConverter\":{\"address\":\"../../converters/RequestConverter.js\",\"functionName\":\"convert\"},\"responseConverter\":{\"address\":\"../../converters/ResponseConverter.js\",\"functionName\":\"convert\"},\"errorConverter\":{\"address\":\"../../converters/ErrorConverter.js\",\"functionName\":\"convert\"}}");
